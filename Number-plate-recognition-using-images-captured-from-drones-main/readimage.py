...
img = cv2.imread(r'C:\Users\HP\Downloads\Number-plate-recognition-using-images-captured-from-drones-main\Number-plate-recognition-using-images-captured-from-drones-main\Data\3.jpg')
